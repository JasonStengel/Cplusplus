...
the
number of primes requested. For example, if 10 primes were requested,
your array will contain: 2, 3, 5, 7, 11, 13, 17, 19, 23, and 29.
...
void PrintNumbers(array_sizes *pArraySizes)
{
	...
	for (pt = pArraySizes->pArrayPrimes, count = 1; count <= pArraySizes->arr_size; pt++, count++)
	{
